<nav class="topnavigation">
	<ul>
		<li><a href="#">Notre association</a>
			<ul>
				<li><a href="page.php?page=about">Qui sommes-nous?</a><a href="page.php?page=about&editable">**</a></li>
				<li><a href="page.php?page=historique">Historique</a><a href="page.php?page=historique&editable">**</a></li>
				<li><a href="page.php?page=cons_admin">Conseil d'administration</a><a href="page.php?page=cons_admin&editable">**</a></li>
				<li><a href="page.php?page=organigramme">Organigramme</a><a href="page.php?page=organigramme&editable">**</a></li>
				<li><a href="page.php?page=equipe">Equipe</a><a href="page.php?page=equipe&editable">**</a></li>
		...
		<li><a href="page.php?page=services">Nos services</a>
			<ul>
				...
				<li><a href="page.php?page=ateliers">Ateliers</a>
					<ul>
						...
						<li><a href="page.php?page=atelier_imprimerie">imprimerie</a><a href="page.php?page=atelier_imprimerie&editable">**</a></li>
				...
				<li><a href="page.php?page=jobcoach">Jobcoach</a><a href="page.php?page=jobcoach&editable">**</a></li>
				<li><a href="page.php?page=cia">CIA</a><a href="page.php?page=cia&editable">**</a>
					<ul>
						<li><a href="page.php?page=sia">SIA</a><a href="page.php?page=sia&editable">**</a></li>
						<li><a href="page.php?page=cdl">CDL</a><a href="page.php?page=cdl&editable">**</a></li>
						<li><a href="page.php?page=sad">Service à Domicile</a><a href="page.php?page=sad&editable">**</a></li>
						<li><a href="page.php?page=sc">Service de Consultation</a><a href="page.php?page=sc&editable">**</a></li>
					</ul>
				</li>
			</ul>
		</li>
